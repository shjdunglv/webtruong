...
class CreateMarket: BaseCreatePost {
...
extension CreateMarket: UITextFieldDelegate  {
...
extension CreateMarket : UINavigationControllerDelegate,UIImagePickerControllerDelegate,UICollectionViewDelegateFlowLayout {
...
extension CreateMarket : UICollectionViewDataSource,UICollectionViewDelegate{
...
extension CreateMarket : CellPickedDelegate  {
    ...
    func deleteCell(cell: CellUpLoadImage) {
        my_collection.performBatchUpdates({
            ...
            self.linkImage.remove(at: (indexPath?.item)!)
            self.my_collection.reloadData()
